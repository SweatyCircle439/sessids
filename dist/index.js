    ...
    constructor(data = {}, lifetime = config.lifetime, id = "") {
        ...
        this.update = () => {
            ...
            function set() {
                ...
                return writeFileSync(config.sessfile, JSON.stringify({
                    sessions: sessions
                        .concat(write)
                }, null, 4));
            }
        ...
        this.destroy = () => {
            writeFileSync(config.sessfile, JSON.stringify({ sessions: JSON.parse(readSessions()).sessions.filter((session) => session.id !== this.id) }, null, 4));
